        ...
        <table>
            ...
            <tbody id="reservation-body">
                ...
                while($row = $result->fetch_assoc())
                {
                    ...
                    <td>" . $row["time"] . "</td>
                    <td>
                    <a class = 'btn btn-primary' href= 'accept.php?id=$row[id]&name=$row[name]&email=$row[email]&address=$row[address]&cnum=$row[cnum]&date=$row[date]&time=$row[time]'>Accept</a>
                    <a class = 'btn btn-danger' href= 'reject.php?id=$row[id]'>Reject</a>
                    </td>
                    </tr>";
